...
public class Scenario3 {
    ...
    WebDriverWait wait;
	    ...
	    @Test
	    public void receiveAndRespondToChatMessage() throws InterruptedException, IOException  {
	      ...
	      String pass = c2.getStringCellValue();
	        ...
	        driver.findElement(By.xpath("//input[@type='search']")).sendKeys("Surendran");
	        driver.findElement(By.xpath("//div[@class='list-body MuiBox-root css-1pw4nq3']")).click(); 
	        
	        String receivedMessage = driver.findElement(By.id("//input[@type='textmessage']")).getText();
	        Assert.assertEquals(receivedMessage, "Hello, How are you Anbu!");

	        WebElement messageBox = driver.findElement(By.xpath("//input[@type='textmessage']"));
	        messageBox.sendKeys("Hi, I Am fine.");
